...
var gamestate = 'morningwakeup'
 var classstime;
var gamestate = 'classs'
var lunchtime
var gamestate = 'lunch'
var homeworktime
var gamestate = 'homework'
var sleeptime
var gamestate = 'sleep' 
var schooltime
var gamestate = 'school'
var dinnertime
var gamestate = 'dinner'
...
var classs, classstime
var lunch , lunchtime
var dinner, dinnertime
var sleep , sleeptime
var school , schooltime
var homework, homeworktime
 var hour, minute
function setup() {
...
button.position(800,400)
  ...
  wakeup.position(900,700);
 classs   = createInput('classstime'  );
  classs.position(900,600);
 sleep  = createInput('sleeptime'  );
 sleep.position(900,500);
school  = createInput('schooltime'  );
 school.position(900,400);
homework  = createInput(' homeworktime'  );
 homework.position(900,300);
dinner = createInput('dinnertime')
dinner.position(900,200);
